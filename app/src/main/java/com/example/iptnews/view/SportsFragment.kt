...
import com.example.iptnews.view.viewmodel.SportsModel
...
class SportsFragment : Fragment(){
    ...
    private lateinit var viewModel: SportsModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(SportsModel::class.java)
        viewModel.refresh()
