...
import com.example.iptnews.view.viewmodel.WorldModel
...
class WorldFragment : Fragment(){
    ...
    private lateinit var viewModel:  WorldModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(WorldModel::class.java)
        viewModel.refresh()
